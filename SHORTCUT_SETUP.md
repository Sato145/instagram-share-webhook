...
辞書アクションに `hashtags` キーを追加することで、カスタムハッシュタグを設定できます。
...
これは自動的に `#STU48 #アイドル #瀬戸内` に変換されます。

### プラットフォーム別のショートカット作成

異なるハッシュタグを使いたい場合は、プラットフォームごとにショートカットを作成できます。

#### Instagram用
```
辞書:
  url: ショートカット入力
  hashtags: Instagram 写真
```
...
`hashtags` キーを省略すると、デフォルトのハッシュタグが使用されます。
